...
This is a fork of the excellent [imbusho](https://github.com/imbushuo/mac-precision-touchpad) driver for the Magic Trackpad 2. **It supports Bluetooth**. Currently, it only works on Windows 11: **Windows 10 is not supported** (for now, I'll try to fix the problem ASAP). Compared to imbusho or to the official 2021 Apple driver, this project adds:
